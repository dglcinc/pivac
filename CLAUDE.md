...
| `docs/rpi-io-boards-pcb-plan.md` | Fabricated PCB replacements for the two Phoenix perfboards: dimensions, files to fetch, layout provisions, vendor choice, work plan |
