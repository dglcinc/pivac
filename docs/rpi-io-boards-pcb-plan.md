...
| 5. Order boards and parts | David | three of each board, ordered from OSH Park 2026-09-12 from the Gerber zips; parts per `rpi-io-boards-parts.md` | 2 weeks elapsed |
